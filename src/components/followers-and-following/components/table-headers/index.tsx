...
import { Check, Cross, Tag } from '../../../icons'
import { FollowSortType, ProfileTableTitleType, TagCountType } from '../../../../types'
...
const TableHeader: React.FC<TableHeaderProps> = ({
  ...
  return (
    <div className="bg-neutral shadow-medium z-40 flex w-full flex-col gap-4 rounded-sm p-4 py-2 pl-2">
      <div className="flex w-full justify-between">
        <div className="flex w-full flex-wrap items-center justify-between gap-3 sm:flex-nowrap sm:justify-start">
          ...
          <div className="item-center z-10 flex w-full justify-between gap-4 sm:justify-end">
            <div ref={clickAwaySearchRef as LegacyRef<HTMLDivElement>} className="relative z-50 flex gap-1 sm:gap-3">
              <div
      ...
      {showTags && tagsEmpty && <p className="text-text/40 w-full text-center font-bold italic">no tags</p>}
      {showTags && (
        <div className="flex w-full flex-wrap gap-2">
          {tagsLoading
            ...
            : displayedTags?.map((tag, i) => (
                ...
                >
                  <p className="max-w-[95%] truncate">{tag.tag}</p>
