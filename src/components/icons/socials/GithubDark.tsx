const Github: React.FC<React.SVGProps<SVGSVGElement>> = ({ height = 32, width = 32, ...props }) => {
  return (
    <svg width={width} height={height} {...props} viewBox="0 0 16 16" fill="white" xmlns="http://www.w3.org/2000/svg">
      <path
        fillRule="evenodd"
