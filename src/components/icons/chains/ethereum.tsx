...
const Ethereum: React.FC<React.SVGProps<SVGSVGElement>> = ({ height = 32, width = 32, ...props }) => {
  return (
    <svg height={height} width={width} {...props} viewBox="0 0 1920 1920" xmlns="http://www.w3.org/2000/svg">
